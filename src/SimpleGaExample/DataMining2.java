...
public class DataMining2 {
     ...
     */
    static int conL = 6;
    static int dataNum = 64;
    static int numR = 10;
    static int pop = 200;
    static int generationNum = 400;
    static int geneSize = (conL + 1) * numR;
    static double m_rate = 0.01;
    static double crossRate = 1.0;
    static PrintWriter pw;

    public static void main(String[] args) throws FileNotFoundException {
        pw = new PrintWriter(new File("data2.csv"));

        // READ IN DATA FILE
        Scanner scan = new Scanner(DataMining2.class.getResourceAsStream("data2.txt"));
